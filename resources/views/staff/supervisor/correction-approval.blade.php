        ...
        <div class="pc-content">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Correction Approval</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="card shadow-sm border-0 mb-4">
                        ...
                        <div class="card-body py-3">
                            <div class="row g-3 row-cols-1 row-cols-md-3 row-cols-lg-4 align-items-end">
                                ...
                                <div>
                                    ...
                                    <div class="input-group input-group-sm">
                                        <select id="fil_status" class="form-select">
                                            ...
                                            <option value="7">Rejected: Examiners/Panels [Correction]</option>
                                            <option value="8">Rejected: (Comm/DD/Dean) [Correction]</option>
                                            <option value="5">Approved & Completed</option>
                                        </select>
                                ...
                                {{-- Role --}}
                                <div>
                                    <label class="form-label fw-semibold text-muted small">Supervision Role</label>
                                    <div class="input-group input-group-sm">
                                        ...
                                        <button type="button" class="btn btn-outline-secondary" id="clearRoleFilter"
                                            title="Clear">
                                            <i class="ti ti-x"></i>
                                        </button>
                                    </div>
                ...
                @foreach ($subs as $upd)
                    <!-- [ Approve Modal ] Start -->
                    <form method="POST"
                        action="{{ route('staff-correction-approval-post', ['actCorrID' => Crypt::encrypt($upd->activity_correction_id), 'option' => 1]) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="modal fade" id="approveModal-{{ $upd->activity_correction_id }}"
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <h2 class="f-18">Approve Student Correction?</h2>
                                            </div>
                                            ...
                                            <div class="col-sm-12 mb-3">
                                                <div class="alert alert-light border text-start f-14">
                                                    ...
                                                    <ul class="mb-2 ps-3">
                                                        <li>Carefully review the student's correction document.</li>
                                    ...
                                    <div class="modal-footer">
                                        <div class="d-flex justify-content-between gap-3 w-100">
                                            ...
                                            <button type="submit" class="btn btn-success w-100"
                                                data-submit="{{ $upd->activity_correction_id }}">
                    ...
                    <!-- [ Reject Modal ] Start -->
                    <form method="POST"
                        action="{{ route('staff-correction-approval-post', ['actCorrID' => Crypt::encrypt($upd->activity_correction_id), 'option' => 2]) }}">
                        @csrf
                        <div class="modal fade" id="rejectModal-{{ $upd->activity_correction_id }}"
                            data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered  modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="d-flex justify-content-center align-items-center text-center">
                                                    <h2 class="f-18">Reject Student Correction?</h2>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 mb-3">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <p class="fw-normal f-14 text-center text-muted">
                                                        This action will mark the student's correction as
