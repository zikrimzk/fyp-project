        ...
        <div class="pc-content">
            ...
            <div class="row">
                            ...
                            <div class="alert alert-light d-flex align-items-start gap-3 p-4" role="alert">
                                ...
                                <div class="w-100">
                                    ...
                                    <ul class="mb-0 ps-3 small">
                                        ...
                                        <li class="mb-2">
                                            Supervisors can <strong>revert</strong> the student correction applications if the documents
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="input-group">
                                        <select id="fil_status" class="form-select">
                                            ...
                                            <option value="2" selected>Correction: Pending Supervisor Approval</option>
                ...
                @foreach ($subs as $upd)
                    <!-- [ Approve Modal ] Start -->
                    <form method="POST"
                        action="{{ route('staff-submission-approval-post', ['stuActID' => Crypt::encrypt($upd->activity_correction_id), 'option' => 1]) }}"
                    ...
                    <!-- [ Reject Modal ] Start -->
                    <form method="POST"
                        action="{{ route('staff-submission-approval-post', ['stuActID' => Crypt::encrypt($upd->activity_correction_id), 'option' => 2]) }}">
                        @csrf
                    ...
                    <!-- [ Revert Modal ] Start -->
                    <form method="POST"
                        action="{{ route('staff-submission-approval-post', ['stuActID' => Crypt::encrypt($upd->activity_correction_id), 'option' => 3]) }}">
                        @csrf
