                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Correction Approval Guidelines -->
                            {{-- <div class="alert alert-light d-flex align-items-start gap-3 p-4" role="alert">
                                ...
                                <div class="w-100">
                                    ...
                                    <ul class="mb-0 ps-3 small">
                                        ...
                                        <li class="mb-2">
                                            Each Examiners/Panels can only approve submissions if their
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            {{-- <div class="col-sm-12 mb-3">
                                                ...
                                                <textarea name="comment" id="comment_txt_{{ $upd->activity_correction_id }}" cols="30" rows="4"
