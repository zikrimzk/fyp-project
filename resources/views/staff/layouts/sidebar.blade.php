            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item">
                            <a class="pc-link" href="../demo/layout-color-header.html">Programme Setting</a>
                        </li>
                        <li class="pc-item">
                            <a class="pc-link" href="../demo/layout-compact.html">Semester Setting</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item">
                            <a href="../pages/login-v3.html" target="_blank" class="pc-link">Authentication
                                3</a>
                        </li>
                    </ul>
                </li>
